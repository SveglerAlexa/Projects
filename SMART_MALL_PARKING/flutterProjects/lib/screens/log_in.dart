...
class _LoginScreenState extends State<LoginScreen> {
  ...
  Future<Sofer?> loginUser(String email, String parola) async {
    final url = Uri.parse('http://10.0.2.2:8080/api/soferi/login');
                    ...
                    children: [
                      ...
                      SizedBox(
                        ...
                        child: OutlinedButton(
                          onPressed: () async {
                            Sofer? sofer = await loginUser(
                                emailController.text, parolaController.text);
                            if (sofer != null) {
                              ...
                              ScaffoldMessenger.of(context).showSnackBar(
                                const SnackBar(
                                    content: Text('Email sau parola incorecta')),
                              );
                            }
                          },
